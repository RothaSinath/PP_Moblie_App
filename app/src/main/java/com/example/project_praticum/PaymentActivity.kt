...
//
//        // Initialize views
//        paymentRadioGroup = findViewById<RadioGroup>(R.id.paymentRadioGroup)
//        btnPay = findViewById<MaterialButton>(R.id.btnPay)
//
...
//            var id: Int = paymentRadioGroup.checkedRadioButtonId
//
//            if (id != -1) {
//
...
//    }
    ...
    fun radio_button_click(view: View)
    {
        ...
        val radio: RadioButton = findViewById(paymentRadioGroup.checkedRadioButtonId)
