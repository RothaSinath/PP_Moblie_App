...
class CategoryPlantAdapter(
    ...
    inner class CategoryPlantViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryPlantViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.card_plant_view, parent, false)

        return CategoryPlantViewHolder(view)
    }
